...
$HOME/.composer/vendor/bin/phpcbf --standard=psr2 --extensions=php --ignore=src/Tbbc/MoneyBundle,src/Money,src/Dime/FrontendBundle/Resources/public src
code1=$?
$HOME/.composer/vendor/bin/phpcbf --standard=psr2 --extensions=php --ignore=src/Tbbc/MoneyBundle,src/Money,src/Dime/FrontendBundle/Resources/public src > /dev/null 2>&1
code2=$?
