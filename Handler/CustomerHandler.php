...
class CustomerHandler extends AbstractHandler implements HandlerInterface
{
    ...
    {
        $this->repository->createCurrentQueryBuilder('c');
        ...
        $this->repository->getCurrentQueryBuilder()->addOrderBy('c.name', 'ASC');
