...
class RateGroupHandler extends AbstractHandler implements HandlerInterface
{
    ...
    {       
        $this->repository->createCurrentQueryBuilder('rg');
        ...
        $this->repository->getCurrentQueryBuilder()->addOrderBy('rg.name', 'ASC');
