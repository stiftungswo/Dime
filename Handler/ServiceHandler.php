...
class ServiceHandler extends AbstractHandler implements HandlerInterface
{
    ...
    {       
        $this->repository->createCurrentQueryBuilder('s');
        ...
        $this->repository->getCurrentQueryBuilder()->addOrderBy('s.name', 'ASC');
