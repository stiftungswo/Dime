...
class InvoiceControllerTest extends DimeTestCase
{
    ...
    {
        $this->assertEquals(401, $this->jsonRequest('GET', $this->api_prefix.'/invoices')->getStatusCode());
        $this->loginAs('admin');
    ...
    public function testPostPutDeleteInvoiceActions()
    {
        ...
        $response = $this->jsonRequest(
            'PUT',
            $this->api_prefix.'/invoices/' . ($id+100),
            json_encode(array(
