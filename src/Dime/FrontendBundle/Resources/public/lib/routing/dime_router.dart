...
void dimeRouteInitializer(Router router, RouteViewFactory views) {
  views.configure({
    ...
    'invoices_overview': ngRoute(path: '/invoices/overview', viewHtml: '<invoice-overview></invoice-overview>'),
    'invoice_edit': ngRoute(path: '/invoices/edit/:id', viewHtml: '<invoice-edit></invoice-edit>'),
    'customer_overview': ngRoute(path: '/customers/overview', viewHtml: '<customer-overview></customer-overview>'),
    'customer_edit': ngRoute(path: '/customers/edit/:id', viewHtml: '<customer-edit></customer-edit>'),
    'service_overview': ngRoute(path: '/services/overview', viewHtml: '<service-overview></service-overview>'),
    'service_edit': ngRoute(path: '/services/edit/:id', viewHtml: '<service-edit></service-edit>'),
    'rateGroup_overview': ngRoute(path: '/rateGroups/overview', viewHtml: '<rateGroup-overview></rateGroup-overview>'),
    'rateUnitType_overview': ngRoute(path: '/rateUnitTypes/overview', viewHtml: '<rateUnitType-overview></rateUnitType-overview>'),
    'holiday_overview': ngRoute(path: '/holidays/overview', viewHtml: '<holiday-overview></holiday-overview>'),
    'employee_overview': ngRoute(path: '/employees/overview', viewHtml: '<employee-overview></employee-overview>'),
    'employee_edit': ngRoute(path: '/employees/edit/:id', viewHtml: '<employee-edit></employee-edit>'),
    'expense_report': ngRoute(path: '/reports/expense', viewHtml: '<timeslice-expensereport></timeslice-expensereport>'),
    ...
    'revenue_report': ngRoute(path: '/reports/revenue', viewHtml: '<revenue-report></revenue-report>'),
