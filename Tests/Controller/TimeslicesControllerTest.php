...
class TimeslicesControllerTest extends DimeTestCase
{
    ...
    {
        $this->assertEquals(500, $this->request('GET', $this->api_prefix.'/timeslices', null, array(), array(), array())->getStatusCode());
        $this->loginAs('admin');
        $this->assertEquals(200, $this->request('GET', $this->api_prefix.'/timeslices')->getStatusCode());
    }

    public function testGetActivitiesTimeSlicesAction()
    {
        $this->loginAs('admin');
        $response = $this->request('GET', $this->api_prefix.'/timeslices');
    ...
    public function testGetTimesliceAction()
    {
        ...
        $this->assertEquals(404, $this->request('GET', $this->api_prefix.'/timeslices/11111')->getStatusCode());

        // check existing activity timeslice
        $response = $this->request('GET', $this->api_prefix.'/timeslices/1');
    ...
    public function testPostPutDeleteTimeslicesActions()
    {
        $this->loginAs('admin');
        // create new activity
        $response = $this->request('POST', $this->api_prefix.'/timeslices', json_encode(array(
            'activity'    => '1',
        ...
        $response = $this->request('GET', $this->api_prefix.'/timeslices/' . $id);
        ...
        // modify activity
        $response = $this->request('PUT', $this->api_prefix.'/timeslices/' . $id, json_encode(array(
            'activity'    => '1',
            'startedAt'   => '2012-02-10 19:00:00',
            'stoppedAt'   => '2012-02-10 19:30:00',
            'duration'    => '7200'
        ...
        $response = $this->request('PUT', $this->api_prefix.'/timeslices/' . $id+200, json_encode(array(
            'activity'    => '1',
            'startedAt'   => '2012-02-10 19:00:00',
            'stoppedAt'   => '2012-02-10 19:30:00',
            'duration'    => ''
        ...
        // delete activity
        $response = $this->request('DELETE', $this->api_prefix.'/timeslices/' . $id);
        $this->assertEquals(200, $response->getStatusCode(), $response->getContent());
