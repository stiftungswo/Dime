...
class LoadServices extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
	    ...
	    $projectManagement->setRateUnit('h');
	    ...
	    $qualityAssurance->setRateUnit('h');
