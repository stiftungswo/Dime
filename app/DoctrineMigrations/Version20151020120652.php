 ...
 */
class Version20151020120652 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE projects DROP FOREIGN KEY FK_projects_project_categories');
        $this->addSql('ALTER TABLE projects DROP COLUMN project_category_id');
    }
}
